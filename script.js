...
function getAvailableSpaces(event) {
    ...
    if (turn && pieceId < 12) {
        for (let i = 0; i < redsPieces.length; i++) {
            ...
            if (board[indexOfBoardPiece + 14] === null && cells[indexOfBoardPiece + 14].classList.contains("red") !== true) {
                fourteenthSpace = true;
                redsPieces[i].style.border = "1px solid white";
                redsPieces[pieceId].style.border = "3px solid green";
            }
            if (board[indexOfBoardPiece + 19] === null && cells[indexOfBoardPiece + 19].classList.contains("red") !== true) {
    ...
    if (turn === false && pieceId >= 12) {
        for (let i = 0; i < blacksPieces.length; i++) {
            ...
            if (board[indexOfBoardPiece - 18] === null && cells[indexOfBoardPiece - 18].classList.contains("red") !== true) {
                eighteenthSpace = true;
                blacksPieces[i].style.border = "1px solid white";
                blacksPieces[pieceId].style.border = "3px solid green";
            }
